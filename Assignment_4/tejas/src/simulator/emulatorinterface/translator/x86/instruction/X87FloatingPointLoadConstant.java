...
public class X87FloatingPointLoadConstant implements X86StaticInstructionHandler 
{
					...
					throws InvalidInstructionException
	{
		if( operand1==null && operand2==null && operand3==null) 
		{
			...
			instructionArrayList.appendInstruction(Instruction.getFloatingPointALU(Operand.getImmediateOperand(), null, Registers.getTopFPRegister()));
		}
		else
		{
